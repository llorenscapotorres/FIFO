...
def preview_sale(
    ...
    preview = fifo.preview_sale(db, asset_id, payload.sell_amount, payload.sell_price, current_user.id)
    return {
...
def create_sale(
    ...
    sale = fifo.commit_sale(
        db, asset_id, payload.sale_date, payload.sell_amount, payload.sell_price, current_user.id
    )
...
def update_sale(
    ...
    sale = fifo.recompute_sale(
        db, asset_id, sale_id, payload.sale_date, payload.sell_amount, payload.sell_price, current_user.id
    )
    return _sale_with_breakdown(sale)
